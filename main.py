...
def main():
    print(f"\n===== \U0001F9FE Running Finance Scraper v{SCRIPT_VERSION} at {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} =====")
    ...
    try:
        with sync_playwright() as p:
            ...
            if DO_LEUMI:
                ...
                dl_info.value.save_as(LEUMI_FILE)
            ...
            if DO_MAX:
                ...
                try:
                    ...
                    page.locator("button").filter(has_text="פעולות בכרטיס").first.click()
